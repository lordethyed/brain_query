...
import 'package:brain_quert/src/common/util/platform/error_util_vm.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:brain_quert/src/common/util/platform/error_util_js.dart';
